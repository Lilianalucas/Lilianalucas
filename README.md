...
* **🎓 Teach.me – Assistente de Estudos com IA** *Plataforma de apoio ao aprendizado com assistência inteligente.* `React` `JavaScript` `Gemini API`

* **🚀 NLW Developer (Rocketseat)** *Aplicação Full-Stack com foco em consumo de APIs.* `JavaScript` `Node.js` `APIs`
...
Focada em evoluir de uma entusiasta do desenvolvimento Full-Stack para uma **Engenheira de Software** completa. Acredito na aprendizagem contínua e foco meus estudos em criar códigos limpos e interfaces que contem uma história.

📬 **Vamos nos conectar?** Você pode me encontrar aqui explorando novos repositórios ou através do meu [LinkedIn](SEU_LINK_DO_LINKEDIN_AQUI).
